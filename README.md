...
| `showChilderWhenClose`  | `false`                                                      | Optional                   | If `true`, the children will be shown when the window is closed, ensuring they are displayed in the original component.                          |
